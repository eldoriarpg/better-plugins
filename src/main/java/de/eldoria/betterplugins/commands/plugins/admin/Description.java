...
public class Description extends AdvancedCommand implements ITabExecutor {
    private final Configuration configuration;
    private final Info info;

    public Description(Plugin plugin, Configuration configuration, Info info) {
        super(plugin, CommandMeta.builder("description")
                .addUnlocalizedArgument("plugin", true)
                .addUnlocalizedArgument("description", true)
                .build());
    ...
    public void onCommand(@NotNull CommandSender sender, @NotNull String alias, @NotNull Arguments args) throws CommandException {
        ...
        plugin.get().description(args.join(2));
