...
public class DownloadUrl extends AdvancedCommand implements ITabExecutor {
    private final Configuration configuration;
    private final Info info;

    public DownloadUrl(Plugin plugin, Configuration configuration, Info info) {
        super(plugin, CommandMeta.builder("downloadurl")
                .addUnlocalizedArgument("plugin", true)
                .addUnlocalizedArgument("link", true)
                .build());
    ...
    public void onCommand(@NotNull CommandSender sender, @NotNull String alias, @NotNull Arguments args) throws CommandException {
        ...
        plugin.get().downloadUrl(args.asString(1));
