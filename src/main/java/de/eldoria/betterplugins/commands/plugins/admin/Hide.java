...
public class Hide extends AdvancedCommand implements ITabExecutor {
    private final Configuration configuration;
    private final Info info;

    public Hide(Plugin plugin, Configuration configuration, Info info) {
